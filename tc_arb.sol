...
contract tc_arb {
    ...
    /*
    modifier que verifica dentro de otras funciones que al ejecutar
    la funcion se tenga el valor del fee + el gas
    */
    modifier cost(uint amount) {
        require(msg.value >= amount, "No tiene saldo para ejcutar");
        _;
    }
    ...
    // es como una especie de log-registro de datos
       emit newData(_date,
                    _delivery_date,
                    _product,
                    _price,
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0, "No hay fondos en el contrato");
...
// smart contract en Arbitrum Sepolia == https://sepolia.arbiscan.io/address/0x6f68B65FBB3e685B10B305D5F53B99b99Ee1c1a9
